...
output_dir = "optxt/refrence4"
os.makedirs(output_dir, exist_ok=True)

# Initialize video writer
output_path = os.path.join(output_dir, "refrence4.avi")
        ...
        for r in results:
            for box in r.boxes:
                ...
                if object_id not in unique_objects:
                    ...
                    print(f"New unique object '{object_name}' detected and saved at frame {frame_count}.")
...
output_counts_path = os.path.join(output_dir, "refrence4.txt")
